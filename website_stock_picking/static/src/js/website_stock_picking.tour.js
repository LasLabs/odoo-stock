...
odoo.define('website_stock_picking.website_stock_picking_tour', function(require) {
    'use strict';
    
    var Tour = require('web.Tour');

    Tour.register({
        id: "website_stock_picking_main",
        name: "Check Website Stock Picking Functionality",
        path: "/website_stock_picking/",
        mode: "test",
        steps: [
            {
    ...
    Tour.register({
        id: "website_stock_picking_detail",
        name: "Check Website Stock Picking Detail Functionality",
        path: "/website_stock_picking/1",
        mode: "test",
        steps: [
            {
